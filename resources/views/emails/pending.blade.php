...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="header">
        <h1>Link para pagamento PIX </h1>
      </div>
      <div class="content">
        <p>{{ $details['body'] }}</p>
        <p>Olá {{ $details['nome'] }},</p>
        <p>Facilitamos o pagamento da sua certidão com PIX: rápido, seguro e sem sair de casa. Utilize o código PIX 123.456.789-00 com o valor de <strong> R$ 50,00 </strong> para realizar sua transação. Modernizamos para sua conveniência. </p>
        <p> Após o pagamento, envie o comprovante para o email <b>secretario@certidaocatolica.com.br</b> . Modernizamos para sua conveniência. </p>
